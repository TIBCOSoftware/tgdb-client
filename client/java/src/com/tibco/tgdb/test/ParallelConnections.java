...
public class ParallelConnections {
    ...
    public static void main(String[] args) throws Exception {
        String url = "tcp://127.0.0.1:8222/{connectTimeout=5000}";
        String user = "scott";
        String pwd = "scott";
            ...
            Thread t = new Thread() {
                public void run() {
                    ...
                    try {
                        ...
                        if (gof == null) {
                            throw new Exception("thread-" + j + " TG object factory is null");
                        }

                        Thread.sleep(10000); // sleep a little to make sure we use all connections on server at the same time
