...
func (obj *CharAttribute) GetAttributeDescriptor() types.TGAttributeDescriptor {
...
func (obj *CharAttribute) GetOwner() types.TGEntity {
	return obj.getOwner()
}
...
func (obj *CharAttribute) SetOwner(ownerEntity types.TGEntity) {
...
func (obj *CharAttribute) SetValue(value interface{}) types.TGError {
	...
	if reflect.TypeOf(value).Kind() == reflect.String {
		v, err := utils.StringToInteger(value.(string))
		if err != nil {
...
func (obj *CharAttribute) ReadValue(is types.TGInputStream) types.TGError {
	value, err := is.(*iostream.ProtocolDataInputStream).ReadChar()
	if err != nil {
...
func (obj *CharAttribute) ReadExternal(is types.TGInputStream) types.TGError {
...
func (obj *CharAttribute) WriteExternal(os types.TGOutputStream) types.TGError {
