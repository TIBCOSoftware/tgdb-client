...
func (obj *IntegerAttribute) GetAttributeDescriptor() types.TGAttributeDescriptor {
...
func (obj *IntegerAttribute) GetOwner() types.TGEntity {
	return obj.getOwner()
}
...
func (obj *IntegerAttribute) SetOwner(ownerEntity types.TGEntity) {
...
func (obj *IntegerAttribute) SetValue(value interface{}) types.TGError {
	if value == nil {
...
func (obj *IntegerAttribute) ReadExternal(is types.TGInputStream) types.TGError {
...
func (obj *IntegerAttribute) WriteExternal(os types.TGOutputStream) types.TGError {
