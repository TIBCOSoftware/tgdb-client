...
func (msg *QueryRequestMessage) FromBytes(buffer []byte) (types.TGMessage, types.TGError) {
	...
	logger.Log(fmt.Sprint("Inside QueryRequestMessage:FromBytes - about to readHeader"))
...
func (msg *QueryRequestMessage) ToBytes() ([]byte, int, types.TGError) {
	...
	logger.Log(fmt.Sprint("Inside QueryRequestMessage:ToBytes - about to writeHeader"))
