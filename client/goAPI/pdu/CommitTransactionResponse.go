...
func (msg *CommitTransactionResponse) FromBytes(buffer []byte) (types.TGMessage, types.TGError) {
	...
	logger.Log(fmt.Sprint("Inside CommitTransactionResponse:FromBytes - about to readHeader"))
...
func (msg *CommitTransactionResponse) ToBytes() ([]byte, int, types.TGError) {
	...
	logger.Log(fmt.Sprint("Inside CommitTransactionResponse:ToBytes - about to writeHeader"))
