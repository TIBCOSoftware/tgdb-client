...
func (msg *AuthenticateRequestMessage) FromBytes(buffer []byte) (types.TGMessage, types.TGError) {
	...
	logger.Log(fmt.Sprint("Inside AuthenticateRequestMessage:FromBytes - about to readHeader"))
...
func (msg *AuthenticateRequestMessage) ToBytes() ([]byte, int, types.TGError) {
	...
	logger.Log(fmt.Sprint("Inside AuthenticateRequestMessage:ToBytes - about to writeHeader"))
