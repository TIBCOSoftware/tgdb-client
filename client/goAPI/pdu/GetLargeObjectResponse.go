...
func (msg *GetLargeObjectResponseMessage) FromBytes(buffer []byte) (types.TGMessage, types.TGError) {
	...
	logger.Log(fmt.Sprint("Inside GetLargeObjectResponseMessage:FromBytes - about to readHeader"))
...
func (msg *GetLargeObjectResponseMessage) ToBytes() ([]byte, int, types.TGError) {
	...
	logger.Log(fmt.Sprint("Inside GetLargeObjectResponseMessage:ToBytes - about to writeHeader"))
