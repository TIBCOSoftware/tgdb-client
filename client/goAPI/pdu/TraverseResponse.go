...
func (msg *TraverseResponseMessage) FromBytes(buffer []byte) (types.TGMessage, types.TGError) {
	...
	logger.Log(fmt.Sprint("Inside TraverseResponseMessage:FromBytes - about to readHeader"))
...
func (msg *TraverseResponseMessage) ToBytes() ([]byte, int, types.TGError) {
	...
	logger.Log(fmt.Sprint("Inside TraverseResponseMessage:ToBytes - about to writeHeader"))
