...
func (msg *TraverseRequestMessage) FromBytes(buffer []byte) (types.TGMessage, types.TGError) {
	...
	logger.Log(fmt.Sprint("Inside TraverseRequestMessage:FromBytes - about to readHeader"))
...
func (msg *TraverseRequestMessage) ToBytes() ([]byte, int, types.TGError) {
	...
	logger.Log(fmt.Sprint("Inside TraverseRequestMessage:ToBytes - about to writeHeader"))
