...
func (msg *TraverseRequestMessage) FromBytes(buffer []byte) (types.TGMessage, types.TGError) {
	...
	logger.Log(fmt.Sprintf("Returning TraverseRequestMessage::FromBytes resulted in '%+v'", msg))
	return msg, nil
}
...
func (msg *TraverseRequestMessage) ToBytes() ([]byte, int, types.TGError) {
	...
	logger.Log(fmt.Sprintf("Returning TraverseRequestMessage::ToBytes results bytes-on-the-wire in '%+v'", os.GetBuffer()))
