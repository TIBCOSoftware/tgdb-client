...
func (msg *TraverseRequestMessage) FromBytes(buffer []byte) (types.TGMessage, types.TGError) {
	logger.Log(fmt.Sprint("Entering TraverseRequestMessage:FromBytes"))
	if len(buffer) < 0 {
	...
	logger.Log(fmt.Sprintf("Inside TraverseRequestMessage:FromBytes read bufLen as '%+v'", bufLen))
	...
	logger.Log(fmt.Sprint("Inside TraverseRequestMessage:FromBytes - about to APMReadHeader"))
	...
	logger.Log(fmt.Sprint("Inside TraverseRequestMessage:FromBytes - about to ReadPayload"))
	...
	logger.Log(fmt.Sprintf("TraverseRequestMessage::FromBytes resulted in '%+v'", msg))
	return msg, nil
}

// GetSessionId gets Session id
func (msg *TraverseRequestMessage) ToBytes() ([]byte, int, types.TGError) {
	logger.Log(fmt.Sprint("Entering TraverseRequestMessage:ToBytes"))
	os := iostream.DefaultProtocolDataOutputStream()

	logger.Log(fmt.Sprint("Inside TraverseRequestMessage:ToBytes - about to APMWriteHeader"))
	...
	logger.Log(fmt.Sprint("Inside TraverseRequestMessage:ToBytes - about to WritePayload"))
	...
	logger.Log(fmt.Sprintf("TraverseRequestMessage::ToBytes results bytes-on-the-wire in '%+v'", os.GetBuffer()))
...
func (msg *TraverseRequestMessage) SetTimestamp(timestamp int64) types.TGError {
...
func (msg *TraverseRequestMessage) UpdateSequenceAndTimeStamp(timestamp int64) types.TGError {
...
func (msg *TraverseRequestMessage) ReadHeader(is types.TGInputStream) types.TGError {
	return APMReadHeader(msg, is)
}

// WriteHeader exports the values of the common message header attributes to output stream
func (msg *TraverseRequestMessage) WriteHeader(os types.TGOutputStream) types.TGError {
...
func (msg *TraverseRequestMessage) ReadPayload(is types.TGInputStream) types.TGError {
	// No-Op for Now
	return nil
}

// WritePayload exports the values of the message specific payload attributes to output stream
func (msg *TraverseRequestMessage) WritePayload(os types.TGOutputStream) types.TGError {
	// No-Op for Now
	return nil
}
