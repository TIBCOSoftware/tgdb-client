...
func (msg *BeginTransactionRequestMessage) FromBytes(buffer []byte) (types.TGMessage, types.TGError) {
	...
	logger.Log(fmt.Sprint("Inside BeginTransactionRequestMessage:FromBytes - about to readHeader"))
...
func (msg *BeginTransactionRequestMessage) ToBytes() ([]byte, int, types.TGError) {
	...
	logger.Log(fmt.Sprint("Inside BeginTransactionRequestMessage:ToBytes - about to writeHeader"))
