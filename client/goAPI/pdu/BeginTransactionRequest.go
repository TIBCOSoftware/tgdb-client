 ...
 *
 * File name: BeginTransactionRequest.go
...
func (msg *BeginTransactionRequestMessage) FromBytes(buffer []byte) (types.TGMessage, types.TGError) {
	...
	logger.Log(fmt.Sprintf("Returning BeginTransactionRequestMessage::FromBytes resulted in '%+v'", msg))
	return msg, nil
}
...
func (msg *BeginTransactionRequestMessage) ToBytes() ([]byte, int, types.TGError) {
	...
	logger.Log(fmt.Sprintf("Returning BeginTransactionRequestMessage::ToBytes results bytes-on-the-wire in '%+v'", os.GetBuffer()))
