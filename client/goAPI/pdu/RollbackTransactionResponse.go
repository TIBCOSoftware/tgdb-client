...
func (msg *RollbackTransactionResponseMessage) FromBytes(buffer []byte) (types.TGMessage, types.TGError) {
	...
	logger.Log(fmt.Sprint("Inside RollbackTransactionResponseMessage:FromBytes - about to APMReadHeader"))
...
func (msg *RollbackTransactionResponseMessage) ToBytes() ([]byte, int, types.TGError) {
	...
	logger.Log(fmt.Sprint("Inside RollbackTransactionResponseMessage:ToBytes - about to APMWriteHeader"))
