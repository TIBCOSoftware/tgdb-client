...
func (msg *GetEntityRequestMessage) FromBytes(buffer []byte) (types.TGMessage, types.TGError) {
	...
	logger.Log(fmt.Sprint("Inside GetEntityRequestMessage:FromBytes - about to readHeader"))
...
func (msg *GetEntityRequestMessage) ToBytes() ([]byte, int, types.TGError) {
	...
	logger.Log(fmt.Sprint("Inside GetEntityRequestMessage:ToBytes - about to writeHeader"))
