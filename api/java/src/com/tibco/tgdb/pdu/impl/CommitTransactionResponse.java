 ...
 * Created by: suresh 
 * <p/>
 * SVN Id: $Id: CommitTransactionResponse.java 4018 2020-05-22 20:53:23Z ssubrama $
 */
...
public class CommitTransactionResponse extends AbstractProtocolMessage {
    ...
    public enum TransactionStatus {
        ...
        TGTxnInvalidPhase,
        TGTransactionWriteAheadLogBusy,
        TGTransactionWriteAheadLogFailed2Commit;
    ...
    private TGTransactionException processTransactionStatus(TGInputStream is, int status) throws TGTransactionException {
        ...
        switch (ts) {
            ...
            default:
                ...
                return TGTransactionException.buildException(ts, msg, status);
        }
