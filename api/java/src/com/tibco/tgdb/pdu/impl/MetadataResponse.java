 ...
 * Created by: chung 
 * <p/>
 * SVN Id: $Id: MetadataResponse.java 3876 2020-04-16 21:34:48Z nimish $
 */
...
public class MetadataResponse extends AbstractProtocolMessage {
    ...
    private ArrayList<TGAttributeDescriptor> attrDescList = new ArrayList<TGAttributeDescriptor>();
    private ArrayList<TGNodeType> nodeTypeList = new ArrayList<TGNodeType>(); 
    private ArrayList<TGEdgeType> edgeTypeList = new ArrayList<TGEdgeType>(); 
