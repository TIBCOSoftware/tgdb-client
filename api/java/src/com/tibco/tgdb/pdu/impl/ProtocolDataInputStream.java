 ...
 * Created by: suresh
 * <p/>
 * SVN Id: $Id: ProtocolDataInputStream.java 3631 2019-12-11 01:12:03Z ssubrama $
 */
...
public class ProtocolDataInputStream extends InputStream implements TGInputStream{
    ...
    public String readUTF() throws IOException {
        ...
        short len = readShort();
//        if (len == 0) {
//            throw new IOException("Failed to read UTF String");
//        }
        byte[] buf = new byte[len];
        for (int i=0; i<len; i++) {
            buf[i] = readByte();
        }
        return new String(buf, Charset.forName("UTF8"));
