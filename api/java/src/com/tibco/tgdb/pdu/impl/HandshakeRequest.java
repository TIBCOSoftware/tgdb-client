 ...
 * Created by: suresh
 * <p/>
 * SVN Id: $Id: HandshakeRequest.java 3631 2019-12-11 01:12:03Z ssubrama $
 */
...
public class HandshakeRequest extends AbstractProtocolMessage {
    ...
    public static void main(String[] args) throws Exception {
        HandshakeRequest hs = new HandshakeRequest();
        hs.requestType = RequestType.Initiate;
        System.out.println(HexUtils.formatHex(hs.toBytes(), hs.bufLength));
