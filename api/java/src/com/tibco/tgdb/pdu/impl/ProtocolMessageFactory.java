 ...
 * Created by: suresh
 * <p/>
 * SVN Id: $Id: ProtocolMessageFactory.java 3996 2020-05-16 01:09:49Z vchung $
 */
...
public class ProtocolMessageFactory extends TGMessageFactory {
    ...
    public TGMessage createMessage(VerbId verbId) throws TGException {
        ...
        try {
            ...
            if (klazz == null)
                throw new TGBadVerb(String.format("Invalid verbid:%s specified for Message construction", verbId));
