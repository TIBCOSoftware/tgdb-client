 ...
 * <p/>
 * File name: HttpChannel.java
 * Created on: 1/7/15
 * Created by: suresh 
 * <p/>
 * SVN Id: $Id: HttpChannel.java 3996 2020-05-16 01:09:49Z vchung $
 */
            ...
            if (q > 0)
            {
                ...
                if (scheme.equalsIgnoreCase("basic"))
                {
                    ...
                    throw new TGAuthenticationException(
                            "Proxy rejected connection attempt : " + status.statusString, status.statusCode, realm);
                }
                else
                {
