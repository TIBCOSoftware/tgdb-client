 ...
 *
 * <p/>
 * File name: LinkUrl.java
 * Created on: 12/16/14
 * Created by: suresh
 * <p/>
 * SVN Id: $Id: LinkUrl.java 3882 2020-04-17 00:27:45Z nimish $
 */
...
public class LinkUrl implements TGChannelUrl
{
    ...
    /**
     * URL is of the form protocol://host:port/{name=value;name=value...}
     *
     * @param url
     * @return
     * @throws Exception
    ...
    public static void main(String[] args) throws Exception {
        ...
        LinkUrl url = (LinkUrl) LinkUrl.parse("tcp://scott@foo.bar.com:8222");

        System.out.println("urlstr - case1 :" + url);

        url = (LinkUrl) LinkUrl.parse("tcp://foo.bar.com:8222/{userID=scott;ftHosts=foo1.bar.com,foo2.bar.com;sendSize=120}");
    ...
    private String parseHostAndPort(String hostAndPort) throws TGException
    {
        if (hostAndPort.length() == 0) {
            this.host = gDefaultHost;  //Should take from the env.
            this.port = gDefaultPort;  //default values
            return ""; //Empty String
        }
        int offset = 0;
