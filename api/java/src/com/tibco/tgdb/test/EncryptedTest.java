 ...
 * Created by: suresh
 * SVN Id: $Id: EncryptedTest.java 3292 2019-08-08 17:30:06Z jyang $
 */
...
/**
 * Before running, initialize database using
 * ./tgdb -f -i -c {datapath of encrypt-initdb.conf}
 * Example: ./tgdb -f -i -c /Users/jyang/tgdb/2.0/api/java/src/com/tibco/tgdb/test/encrypt-initdb.conf
 *
 * Run the database with
 * ./tgdb -s -c (dapath of encrypt-tgdb.conf
 * Example: ./tgdb -s -c /Users/jyang/tgdb/2.0/api/java/src/com/tibco/tgdb/test/encrypt-tgdb.conf
 * Then you can run the test fron IntelliJ
 *
 * This test demonstrates successful creation of an encyptedNode for sensitive Data and a successful retrieval of
 * the encrypted data from the database
 */
