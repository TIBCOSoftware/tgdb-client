 ...
 */
func Test1(conn tgdb.TGConnection, gof tgdb.TGGraphObjectFactory) {
...
func Test2(conn tgdb.TGConnection, gof tgdb.TGGraphObjectFactory) {
	...
	n, _ := impl.NewTGDecimalFromString("234235732234235723590735124523.89813275891735070")
