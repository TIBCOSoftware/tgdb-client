...
func connect() (tgdb.TGConnection, tgdb.TGError) {
	qConnFactory := impl.NewTGConnectionFactory()
...
func disConnect(qConn tgdb.TGConnection) {
...
func createNode(gof tgdb.TGGraphObjectFactory, nodeType tgdb.TGNodeType) (tgdb.TGNode, tgdb.TGError) {
	if nodeType != nil {
...
func createTestData(qConn tgdb.TGConnection) tgdb.TGError {
	...
	if err != nil {
		...
		return impl.GetErrorByType(impl.TGErrorIOException, impl.INTERNAL_SERVER_ERROR, errMsg, "")
	}
	...
	// Edge # 1
	edge1, err := gof.CreateEdgeWithDirection(node1, node31, tgdb.DirectionTypeBiDirectional)
	if err != nil {
	...
	// Edge # 2
	edge2, err := gof.CreateEdgeWithDirection(node1, node23, tgdb.DirectionTypeBiDirectional)
	if err != nil {
	...
	// Edge # 3
	edge3, err := gof.CreateEdgeWithDirection(node1, node24, tgdb.DirectionTypeBiDirectional)
	if err != nil {
	...
	// Edge # 4
	edge4, err := gof.CreateEdgeWithDirection(node1, node12, tgdb.DirectionTypeBiDirectional)
	if err != nil {
	...
	// Edge # 5
	edge5, err := gof.CreateEdgeWithDirection(node13, node15, tgdb.DirectionTypeBiDirectional)
	if err != nil {
	...
	// Edge # 6
	edge6, err := gof.CreateEdgeWithDirection(node13, node22, tgdb.DirectionTypeBiDirectional)
	if err != nil {
	...
	// Edge # 7
	edge7, err := gof.CreateEdgeWithDirection(node13, node32, tgdb.DirectionTypeBiDirectional)
	if err != nil {
...
func testPKey(qConn tgdb.TGConnection) tgdb.TGError {
	fmt.Println(">>>>>>> Entering testPKey: A Unique Query <<<<<<<")

	option := impl.DefaultQueryOption()
...
func testPartialUnique(qConn tgdb.TGConnection) tgdb.TGError {
...
func testNonUnique(qConn tgdb.TGConnection) tgdb.TGError {
...
func testGreaterThan(qConn tgdb.TGConnection) tgdb.TGError {
...
func testLessThan(qConn tgdb.TGConnection) tgdb.TGError {
...
func testRange(qConn tgdb.TGConnection) tgdb.TGError {
...
func testComplex(qConn tgdb.TGConnection) tgdb.TGError {
...
func testNodeTypeOnly(qConn tgdb.TGConnection) tgdb.TGError {
