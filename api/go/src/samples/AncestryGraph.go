...
func insertAncestryNodes(conn tgdb.TGConnection, gof tgdb.TGGraphObjectFactory) map[string]tgdb.TGNode {
	fmt.Println(">>>>>>> Entering InsertAncestryNodes: Insert Few Family Nodes with individual properties <<<<<<<")

	var houseMemberTable = make(map[string]tgdb.TGNode, 0)
...
func insertRelationEdges(conn tgdb.TGConnection, gof tgdb.TGGraphObjectFactory, houseMemberTable map[string]tgdb.TGNode) {
...
func executeQuery1(conn tgdb.TGConnection, startYear, endYear int) {
...
func executeQuery2(conn tgdb.TGConnection) {
...
func executeQuery3(conn tgdb.TGConnection) {
...
func executeQuery4(conn tgdb.TGConnection) {
...
func executeQuery5(conn tgdb.TGConnection) {
