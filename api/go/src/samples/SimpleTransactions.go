...
func insertTransaction(conn tgdb.TGConnection, gof tgdb.TGGraphObjectFactory) {
...
func getTransaction(conn tgdb.TGConnection, gof tgdb.TGGraphObjectFactory) {
...
func updateTransaction(conn tgdb.TGConnection, gof tgdb.TGGraphObjectFactory) {
...
func queryTransaction(conn tgdb.TGConnection) {
